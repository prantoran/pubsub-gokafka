...
docker run --rm ches/kafka kafka-topics.sh --create --topic senz --partitions 2 --replication-factor 1 --if-not-exists --zookeeper 192.168.4.93:2181
...
docker run --rm ches/kafka kafka-topics.sh --create --topic renz --partitions 2 --replication-factor 1 --if-not-exists --zookeeper 192.168.4.93:2181
