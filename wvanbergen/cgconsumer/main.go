...
const (
	...
	DefaultZookeeperConn = "192.168.4.93:2181"
)
...
var (
	...
	zookeeper      = flag.String("zookeeper", DefaultZookeeperConn, "A comma-separated Zookeeper connection string (e.g. `zookeeper1.local:2181,zookeeper2.local:2181,zookeeper3.local:2181`)")
...
func main() {
	...
	fmt.Println("zookeepnodes:", zookeeperNodes, " chroot:", config.Zookeeper.Chroot)
	...
	for message := range consumer.Messages() {
		fmt.Println("msg topic:", message.Topic, " partition:", message.Partition, " offset:", message.Offset)
